      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-white/5 dark:bg-white/5 p-6 rounded-xl border border-white/10">
            <h3 className="text-xl font-bold mb-3 text-primary">Consent Management</h3>
            <p className="text-black/70 dark:text-white/70">
              Capture, manage, and track user consent across your applications with immutable audit trails and granular purpose-based controls.
            </p>
          </div>
          
          <div className="bg-white/5 dark:bg-white/5 p-6 rounded-xl border border-white/10">
            <h3 className="text-xl font-bold mb-3 text-primary">Compliance Automation</h3>
            <p className="text-black/70 dark:text-white/70">
              Automate compliance with GDPR, CCPA, and other privacy regulations. Built-in templates and workflows for common compliance scenarios.
            </p>
          </div>
          
          <div className="bg-white/5 dark:bg-white/5 p-6 rounded-xl border border-white/10">
            <h3 className="text-xl font-bold mb-3 text-primary">Real-time Auditing</h3>
            <p className="text-black/70 dark:text-white/70">
              Track every data access and consent change with complete transparency logs. Monitor compliance in real-time across your organization.
            </p>
          </div>
          
          <div className="bg-white/5 dark:bg-white/5 p-6 rounded-xl border border-white/10">
            <h3 className="text-xl font-bold mb-3 text-primary">Developer First</h3>
            <p className="text-black/70 dark:text-white/70">
              Simple SDKs for JavaScript, Python, and mobile platforms. Comprehensive documentation, quickstart guides, and dedicated support.
            </p>
          </div>
        </div>
